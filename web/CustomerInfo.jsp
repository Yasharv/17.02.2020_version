...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("CustomerInfo.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("PersInf")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="CustomerForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                ...
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" value="1" name="cus1" class="cus1"  checked =true > <label><%=properties.getProperty("Fizik")%></label><br>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" value="1" name="cus3" class="cus3"> <label><%=properties.getProperty("FerdiSahib")%></label><br>
