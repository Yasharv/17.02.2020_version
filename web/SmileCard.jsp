...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("SmileCard.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("SmileCard")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="SmileCardForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="product" style="width: 150px">
                                                    ...
                                                    <option value="892"><%=properties.getProperty("Smile6")%></option>
                                                    <option value="893"><%=properties.getProperty("Smile12")%></option>                    
                                                </select>
                                            </td>
                                        </tr> 
                                        <tr>                 
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Amnt")%></td>
                                            <td>
                                                <select name="amount_rel" style="width: 150px">
                                            ...
                                            <td>
                                                ...
                                                <font color="red" id="errmsg1"></font>
                                            </td>
                                        </tr>                      
