...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("MarketingCred.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="MarketingCredForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td width="150"  height="33"><%=properties.getProperty("ValueDateFrom")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td width="150"  height="33"><%=properties.getProperty("ValueDateTo")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td width="150"   height="33"><%=properties.getProperty("EndDateFrom")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td width="150"   height="33"><%=properties.getProperty("EndDateTo")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
