...
<html>
    ...
    <body bgcolor=#E0EBEA> <!--  #E8E8E8 -->
        ...
        <table border="0" width="100%" style="height: 100%;"> 
            <col width="200">
            <tr>
                <td width="246" height="60">  <font face="Times new roman" size="5">  Gəlir-Xərc hesabatı </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top"> 
                    ...
                    <form method="post"  name="post" action="IncExpRepForms.jsp<%out.print("?uname=" + user_name + "&br=" + br);%>" onsubmit="return validateForm()" target="_blank" >
