...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("AkkredGuar.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("AkkrGuar")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="AkkredGuarForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <input type="radio" name="status" value="1" checked><%=properties.getProperty("Both")%>
                                                <input type="radio" name="status" value="2"><%=properties.getProperty("Akkr")%>
                                                <input type="radio" name="status" value="3"><%=properties.getProperty("Guar")%> 
                                            </td>
                                        </tr>   
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Special")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
