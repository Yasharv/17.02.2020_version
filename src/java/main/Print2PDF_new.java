 ...
 * @author m.aliyev
 */
@WebServlet(name = "Print2PDF_new", urlPatterns = {"/Print2PDF_new"})
public class Print2PDF_new extends HttpServlet {
...
//------- emeliyyatlar 
        ...
        while (sqlres.next()) {
            ...
            if ((salary_gr.equals("0")) && (acc != 0)) {
                cell = new PdfPCell(new Phrase("XXXXXX", font));
            } else {
...
//  cell = new PdfPCell(new Phrase("XXXXXXX", font));
            } else {
                cell = new PdfPCell(new Phrase(Teyinat, font));
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                Logger.getLogger(Print2PDF_new.class.getName()).log(Level.SEVERE, null, ex);
            }
