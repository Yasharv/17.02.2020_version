...
public class StatementRep {
    ...
    public String main(String acc_no, String acc_name, String curr_name, int CurrID, String acc_open_date, String cust_inn, String DateB, String DateE, String AP, String reval, String br, boolean insurance, String salary_gr, String repLang) throws UnknownHostException {
...
//----------------------------------------------------------------------
            ...
            if (repLang.equals("ENG")){
                grid = " <table border='1' width='900' bgcolor='white' >"
                    ...
                    + "  </tr>"
                    + " <tr>"
                    + " <td align='left'>Operation date:</td>"
                    ...
                    + "  </tr>"
                    + " <tr>"
                    + "  <td align='left'>Previous operation date:</td>"
                    ...
                    + "  </tr>"
                    + " <tr>"
                    + "  <td valign='top' align='left'>Balance beginning of day:</td>"
                    ...
                    + "  <td><hr>Date:</td>"
                    + "  <td><hr>Currency</td>"
                    + "  <td><hr>Opposite account:</td>"
                    + "  <td><hr><center>Debit</center></td>"
                    + " <td><hr>&nbsp;</td>"
                    + "  <td><hr><center>Credit</center></td>"
                    + " <td colspan=2><hr>Payment purpose</td>"
                    + " </tr> ";
            }
            else{
            grid = " <table border='1' width='900' bgcolor='white' >"
            ...
            if(repLang.equals("ENG")){
                    ...
                    + "  <tr>"
                    + " <td width='159' height='23' valign='top'>Balance end of day:</td>"
            ...
            Logger.getLogger(StatementRep.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                sqlres.close();
                stmt.close();
