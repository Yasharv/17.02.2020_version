...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("CarPricing.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("CarPricin")%>
                    </font> </td>
                <td align="right">
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Colour")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("AvtMark")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("AvtModel")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("SuretQutusu")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
