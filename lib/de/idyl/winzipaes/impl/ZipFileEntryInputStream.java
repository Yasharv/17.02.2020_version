...
/**
 * Provide InputStream access to <b>compressed data</b> from one ZipEntry
 * contained within one ZipFile. Necessary as java.util.zip.ZipInputStream only
 * provides access to the <b>uncompressed data</b>.
 *
