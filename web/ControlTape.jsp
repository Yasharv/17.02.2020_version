        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="ControlTapeRepForms.jsp<%out.print("?uname="+user_name+"&br="+br);%>" target="_blank" name="post" onsubmit="return validateForm()" >
                                    ...
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="radio" name="RepType" value="1" checked>Balans
                                                <input type="radio" name="RepType" value="2">Balansdankənar

                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="150" height="33">Tarix:</td>
                                            <td width="110">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="RepForm" style="width: 150px">
                                                    <option value="0">Məcmu</option>
                                                    <option value="1">Çap (Excel)</option>
                                                    <option value="2">Hesabat</option>
                                                </select>
                                            </td>
                                        </tr> 
