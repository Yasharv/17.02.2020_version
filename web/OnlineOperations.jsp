...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("OnlineOperations.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("OnlineOperat")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="OnlineForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
