<%-- 
    Document   : MkrStats
    Created on : Oct 2, 2018, 5:10:46 PM
    Author     : r.ganiyev
--%>
...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("MkrStats.properties"); 
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="MkrStatsForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                ...
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input type="radio" name="status" value="1" checked><%=properties.getProperty("Old")%>
                                                <input type="radio" name="status" value="2"><%=properties.getProperty("New")%> 
                                            </td>
                                        </tr>    
                                        <tr>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("PersonId")%></td>
                                            <td>
                                                <select style="width: 150px" >
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="PersonId"  id ="persid"  value=""  />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="27"><%=properties.getProperty("FinCode")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="FinCode" value="" />
                                            </td>
                                        </tr>
                                        <tr>
