 ...
 * @author m.aliyev
 */
@WebServlet(name = "Print2PDF_1", urlPatterns = {"/Print2PDF_1"})
public class Print2PDF_1 extends HttpServlet {
    ...
    public void AddTrByAccNo(Document document, PdfWriter writer, String acc_no, String DateB, String DateE, String AccMaxDate, boolean insurance, String salary_gr) throws DocumentException, IOException, SQLException, ClassNotFoundException, ParseException {
        ...
        String SQLText = "  select a.* , b.BALANCE_FCY_AMOUNT, b.BALANCE_LCY_AMOUNT from (   "
                ...
                + teyinatSQL + ","
                + " currency_dt_id,currency_cr_id, currency_dt_id Hval , acct_no_dt hesab "
                + " FROM " + view + " a  where "
                ...
                + teyinatSQL + ","
                + " currency_dt_id,currency_cr_id, currency_cr_id Hval, acct_no_cr hesab "
                + " FROM " + view + " a  where"
...
//----------------------------------------------------------------------
        ...
        document.add(new Chunk("          ", font));
        document.add(new Chunk("Qalıq", font));
        document.add(new Chunk("              ", font));
...
//------- emeliyyatlar 
        ...
        while (sqlres.next()) {
            ...
            mebleg = sqlres.getDouble(13);
            mebleg_lcy = sqlres.getDouble(14);
            ...
            table.setWidths(new float[]{1.5f, 0.7f, 4.3f, 1.5f, 1.5f, 1.5f, 5});
            PdfPCell cell;
            ...
            if (!((dCurrID == 944) && (cCurrID == 944))) {
                ...
                cell = new PdfPCell(new Phrase((mebl + "\n" + meb), font));
                //  cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                cell.setBorder(0);
                table.addCell(cell);
            } else {
                ...
                cell = new PdfPCell(new Phrase(mebl, font));
                //   cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                cell.setBorder(0);
                table.addCell(cell);
            }
