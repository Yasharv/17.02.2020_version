 ...
 * @author m.aliyev
 */
@WebServlet(name = "StmtExcelTest1", urlPatterns = {"/StmtExcelTest1"})
public class StmtExcelTest1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setHeader("Content-Disposition", "attachment;filename=HesabdanChixarish12.xls");
        ...
        try {
            ...
            while (sqlresAccs.next()) {
                ...
                if (turnover.equals("1")) {
                    if (stdb.getTrCount(acc_no, strDateB, strDateE, TrType, salary_gr) > 0) {
                        ...
                        i++;
                        ArrayOfStmtTransactions aost = stdb.getTransactions(acc_no, strDateB, strDateE, TrType, insurance, salary_gr);
            ...
            Logger.getLogger(StmtExcelTest1.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                os.flush();
                os.close();
