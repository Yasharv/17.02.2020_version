...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("AccountClosed.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("ClosedAcc")%>
                    </font> </td>
                <td align="right">
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td width="150"  height="33"><%=properties.getProperty("OpenDateFrom")%></td>
                                            <td width="110">
                                        ...
                                        <tr>
                                            <td width="150"  height="33"><%=properties.getProperty("OpenDateTo")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td width="150"   height="33"><%=properties.getProperty("ClosureDateFrom")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td width="150"   height="33"><%=properties.getProperty("ClosureDateTo")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
