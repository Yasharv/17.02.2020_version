<%-- 
    Document   : Postfacktum
    Created on : Feb 1, 2019, 4:41:33 PM
    Author     : r.ganiyev
--%>
...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("Postfacktum.properties");
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="PostfacktumForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                        <font size="4" face='Times New Roman'>
                        <!-- </div> -->
                        <table width="540" height="120" border="1" >
                            <tr>
                                <td>
                                    <table width="535" style="padding-right: 35; background-color: #EBF9F9" height="101" border="0" bgcolor=#EBF9F9>
                                       
                                        <tr>
                                            <td height="31"><%=properties.getProperty("Dates")%></td>
                                            <td>
                                            ...
                                            <td width="130">
                                                <input type="text" id="to" name="TrDate" value= <% out.print('"'+s+'"'); %> />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="150" height="33"><%=properties.getProperty("PostStatus")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td width="130"> 
                                                <input type="text" name="PstStat" />
                                            </td>
                                        </tr>
                                        
                                        <tr>
                                            <td width="150" height="33"><%=properties.getProperty("CorrStatus")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td width="130"> 
                                                <input type="text"  name="CorrStat" />
                                            </td>
                                        </tr>
                                        
                                        <tr>
                                            <td width="150" height="33"><%=properties.getProperty("ErrType")%></td>
                                            <td width="110">
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
