...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("STP.properties");
    %>
    <head>
  ...
  //String frmActPath="StatmRep.jsp?uname="+user_name+"&br="+br;
        ...
        <table border="0" width="100%" height="100%"> 
            <col width="200">
            <tr>
                <td width="246" height="60">  <font face="Times new roman" size="5">  <%=properties.getProperty("StatSTP")%> </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top"> 
                    ...
                    <form method="post"  name="post" action="StatmRepSTPRForm.jsp" target="_blank" onsubmit="return validateForm()" >
