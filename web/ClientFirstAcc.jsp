<%-- 
    Document   : ClientFirstAcc
    Created on : Feb 6, 2019, 5:00:48 PM
    Author     : r.ganiyev
--%>
...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("ClientFirstAcc.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("FirstAcc")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="ClientFirstAccForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
