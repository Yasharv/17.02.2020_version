...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("TodayBalance.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("RestTurnOv")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="TodayBalRep.jsp<%out.print("?uname="+user_name+"&br="+br);%>" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td width="150" height="33"><%=properties.getProperty("Dates")%></td>
                                            <td width="110">
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("GlAccNo")%></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="27"> <%=properties.getProperty("ReportForm")%> </td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <select name="RepForm" style="width: 150px">
                                                    <option value="0"><%=properties.getProperty("RemGlAccNo")%></option>
                                                    <option value="1"><%=properties.getProperty("RemPeriodGlNo")%></option>
                                                </select>
                                            </td>
                                        </tr> 
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Balance")%></td>
                                            <td>
                                                <font size="3"> <input type="radio" name="BalType" value="0" checked><%=properties.getProperty("WithCurrency")%><br> </font>
                                            </td>
                                            <td>
                                                <font size="3"> <input type="radio" name="BalType" value="1"><%=properties.getProperty("WithLocalCurrency")%> </font>
                                            </td>
                                        </tr>
