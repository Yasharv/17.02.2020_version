...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("Collateral.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("CollereralDep")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="CollateralForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="RepCateg" style="width: 150px">
                                                    <option value="0"><%=properties.getProperty("AllCateg")%></option>
                                                    <option value="21003"><%=properties.getProperty("Muc")%></option>
                                                    <option value="21001"><%=properties.getProperty("Class")%></option>
                                                    <option value="21002"><%=properties.getProperty("LegClass")%></option>
                                                    <option value="21004,21005"><%=properties.getProperty("LegalClass")%></option>
                                                    <option value="21006"><%=properties.getProperty("Bonus")%></option>
