...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("Terminal.properties");
    %>
    <head>
    ...
    <body bgcolor=#E0EBEA>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="TerminalForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("TerminalId")%></td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" name="terminal" value="" />
                                            </td>
                                        </tr>
