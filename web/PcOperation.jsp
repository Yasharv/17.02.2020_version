...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("PcOperation.properties");
    %>
    <head>
    ...
    <body bgcolor=#E0EBEA>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="PcOperationRepForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Specialist")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="portfolio_sort" value="" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <br>
                                                <div class="container">      
                                                    <%= (card_type.ChkTypeCard(Integer.parseInt(br),1))
