...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("UsrStatistics.properties");
        %>
    ...
    <body bgcolor=#E0EBEA>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="UsrStatRepForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="RepUser" style="width: 155px">
                                                    ...
                                                    <%
                                                        out.println(footer.UserDao(Integer.parseInt(br)));
                                                    %>
                                                </select>
                                            </td>
                                        </tr>
