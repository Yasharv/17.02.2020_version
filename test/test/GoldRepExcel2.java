 ...
 * @author m.aliyev
 */
@WebServlet(name = "GoldRepExcel", urlPatterns = {"/GoldRepExcel"})
public class GoldRepExcel2 extends HttpServlet {
 ...
 /*
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GoldRepExcel2.class.getName()).log(Level.SEVERE, null, ex);
