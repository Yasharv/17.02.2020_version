...
<html>
    ...
    <body bgcolor=#E0EBEA>
        <%
            if (request.getParameter("RepForm") != null) {
                ...
                SqlAccs = SqlAccs + " AND b.date_from = a.date_from"
                 ...
                 //System.out.println("repform "+RepForm);
        ...
        <jsp:forward page="StatmRep.jsp">
            ...
            <jsp:param name="repLang" value="<%=repLang%>"/>
        </jsp:forward>
        <%
                break;
            }
