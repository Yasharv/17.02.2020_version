...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("Operations.properties"); 
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("OperationType")%> 
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="OperationsForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                    ...
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="radio" name="report" value="1" checked><%=properties.getProperty("OperationFT")%>
                                                <input type="radio" name="report" value="2"><%=properties.getProperty("OperationTT")%> 

                                            </td>
                                        </tr> 
                                        <tr>
                                            <td width="150" height="33"><font size="4"><%=properties.getProperty("DateFrom")%></font></td>
                                            <td width="110">
                                        ...
                                        <tr>
                                            <td height="31"><font size="4" ><%=properties.getProperty("DateTo")%></font></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("DebtAccId")%></td>
                                            <td>
                                            ...
                                            <td><input type="text" name="DRepVal"></td>
                                        </tr>
                                        <tr>
                                            <td height="27"><%=properties.getProperty("CredAccId")%></td>
                                            <td>
                                            ...
                                            <td><input type="text" name="CRepVal"></td>
                                        </tr>
