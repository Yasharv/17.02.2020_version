 ...
 *
 * AES256 encrypter for 1 file using 1 PASSWORD + 1 SALT to create 1 KEY used
 * for subsequent calls to encrypt() method.
 *
...
public class AESEncrypterBC extends AESCryptoBase implements AESEncrypter {
    ...
    /**
     * Setup AES encryption based on pwBytes using WinZipAES approach with SALT
     * and pwVerification bytes based on password+salt.
     */
    ...
    /**
     * encrypt 16 bytes (AES standard block size) or less starting at "pos"
     * within "in" byte[]
     */
