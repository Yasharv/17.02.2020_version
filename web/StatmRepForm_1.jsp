        ...
        <%
            if (request.getParameter("RepForm") != null) {
                ...
                /*  String uname = request.getParameter("uname");   
                 ...
                 String closedaccs = request.getParameter("closedaccs");
                 String[] DebVal = request.getParameterValues("DebVal");
                 */
                //   System.out.println(SqlAccs);
                ...
                switch (RepForm) {
                    case 1: {
        %>
        <jsp:forward page="StatmRep_1.jsp">
