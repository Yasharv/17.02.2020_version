...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("AsanFinance.properties"); 
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("AsanFinance")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="AsanFinanceForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                    ...
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="radio" name="report" value="1" checked><%=properties.getProperty("Type1")%>
                                                <input type="radio" name="report" value="2"><%=properties.getProperty("Type2")%> 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="RepUser" style="width: 155px">
                                                    ...
                                                    <%=footer.UserIDWithDaoAsanFinan(Integer.parseInt(br))%>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
