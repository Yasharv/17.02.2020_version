...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("InfoChannel.properties"); 
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="InfoChannelForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td height="27"> <%=properties.getProperty("CustMM")%> </td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <select name="ExbCustMM" style="width: 150px">
                                                    <option value="0">Hamısı</option> 
                                                    <%
                                                        out.println(footer.ExbCustMM());
                                                    %>
                                                </select>
                                            </td>
                                        </tr> 
                                        <tr>
                                            ...
                                            <td>
                                                <select name="RepUser" style="width: 155px">
                                                    ...
                                                    <%=footer.UserIDWithDao(Integer.parseInt(br))%>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
