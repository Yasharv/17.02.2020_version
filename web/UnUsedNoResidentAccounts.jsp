...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("UnUsedNoResidentAccounts.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="UnUsedNoResidentAccountsForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
