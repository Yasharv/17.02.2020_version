...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("OnlineTransferReport.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="OnlineTransferReportForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            <td height="27"><%=properties.getProperty("UploadFileType")%></td>
                                            <td colspan="2">
                                                <input type="radio" name="ZKRepType" value="1" checked><%=properties.getProperty("Transfer")%> 
                                                <input type="radio" name="ZKRepType" value="2"><%=properties.getProperty("Payment")%>    
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("FileName")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="fileNames" value="" />
                                            </td>
                                        </tr> 
                                        <tr>
