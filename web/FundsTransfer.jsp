...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("FundsTransfer.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("FtOperation")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="FundsForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            <td colspan="2">
                                                <input type="radio" name="status" value="1" checked><%=properties.getProperty("Entering")%>
                                                <input type="radio" name="status" value="2"><%=properties.getProperty("Transfer")%>
                                            </td>
                                        </tr> 
                                        <tr>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("CorrespondentBank")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <select name="bank" style="width: 155px">
                                                    <option value="0">Bütün banklar</option> 
                                                    <%=footer.Mbank()%>
                                                </select>
                                            </td>
                                        </tr>  
                                        ...
                                        <tr>
                                            <td  height="30" >
                                                <%=properties.getProperty("TransferName")%>       

                                                <div class="container"> 
                                                    <input type="checkbox" name="chktransfer" class="chkSelectAll"><label><%=properties.getProperty("All")%></label> <br>
                                                    <input type="checkbox" value="XOHKS" name="X" class="transfer"><label><%=properties.getProperty("Xoks")%></label><br>
                                                    <input type="checkbox" value="AZIPS" name="A" class="transfer"><label><%=properties.getProperty("Azips")%></label><br>
                                                    <input type="checkbox" value="SWIFT" name="S" class="transfer"><label><%=properties.getProperty("Swift")%></label><br>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("ReceiveAndSendedBank")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <select name="RSbank" style="width: 155px">
                                                    <option value="0">Bütün banklar</option> 
                                                    <%=footer.bank()%>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("SwiftBic")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="bic_code" value="" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="27"><%=properties.getProperty("ReceiveAndSendedCustIban")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td height="24"><%=properties.getProperty("TypeReport")%></td>
                                            <td>
