...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("AccountOfTransaction.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("AccOfTrans")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="AccountTrForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            <td height="27"><%=properties.getProperty("AccCateg")%></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Iban")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("MonthCnt")%></td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="MonthCnt" value="" />
                                            </td>
                                        </tr> 
                                        <tr>
