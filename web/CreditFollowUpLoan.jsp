...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("CreditFollowUpLoan.properties"); 
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="CreditFollowUpLoanForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                ...
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td width="130"> 
                                                <input type="text" id="from" name="Dates" value= <% out.print('"' + s + '"'); %> />
                                            </td>
                                        </tr>  
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <font size="3"> <input type="radio" name="RepType" value="1" checked><%=properties.getProperty("ExcelFile")%></font>
                                            </td>
                                        </tr>
