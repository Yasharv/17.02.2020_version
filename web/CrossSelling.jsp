...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("CrossSellingRep.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("CrossSell")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="CrossSellingRepForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                ...
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            <td height="27" ></td>
                                            <td colspan="2">
                                                <input type="radio" name="RepCheck" value="0" checked><%=properties.getProperty("Det")%>
                                                <input type="radio" name="RepCheck" value="1" ><%=properties.getProperty("Sum")%>
                                            </td>
                                        </tr>
                                        <tr>
