<%--
Document   : CredRepIdTemp
Created on : jun 07, 2017, 10:16:34 AM
...
<%
        ...
        {
            String ParamsValue = "reportid='" + rep_id + "'";
            ...
            /*String sql_1 = " select p.name, to_char(trunc(PR.REPORT_DATE),'dd/mm/yyyy' ) REPORT_DATE ,"
                         ...
                         + " st where PR.REPORT_ID = '" + rep_id + "' AND PR.fk_person = P.ID and st.FK_PERSON(+) = pr.FK_PERSON group by p.name,"
            ...
            ResultSet sqlSelB = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
            ...
            ResultSet Rsql_2 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
            ...
            ResultSet Rsql_3 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
            ...
            ResultSet Rsql_3_z = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
            ...
            ResultSet Rsql_4 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
            ...
            ResultSet Rsql_5 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
            Rsql_5.next();
...
<INPUT style="float :right;margin: 10px 20px 0px 0px;" TYPE="button" name=print value="Print" onClick="window.print()"
       class="NonPrintable">
<% 
     if (agreement.equals("2")) 
     {
         ...
         array[2] = 12;
          ...
          ResultSet sqlSelB1 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
          sqlSelB1.next();
...
<div class=WordSection1>
    ...
    <p class=MsoNormal align=right style='margin-left:288.0pt;text-align:right;
            ...
            style='color:black'>   imza: ____________________</span></p>
    <br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p class=MsoNormal style='text-autospace:none'><span style='color:black'>s&#601;lahiyy&#601;tli
                                                        &#351;&#601;xsin ad&#305;, soyad&#305;, atas&#305;n&#305;n ad&#305;: ________________________________</span>
    </p>
    ...
    <p class=MsoNormal align=right style='margin-left:288.0pt;text-align:right;
                                                   text-autospace:none'><span style='color:black'>   imza: ____________________</span>
    </p>
...
<FORM name="j_idt6" id="j_idt6" action="/borrower_inquiry/borrowerInqReport.risk"
    ...
    <DIV style="font-family: Arial,sans-serif; font-size: 12px;"><BR><STRONG
            style="color: rgb(0, 112, 163); font-size: x-large;">MƏRKƏZLƏŞDİRİLMİŞ
        ...
        <TABLE>
            ...
            <TR>
                <TD style="width: 360px; font-size: large; font-weight: bold; border-right-color: black; border-right-width: 1px; border-right-style: solid;"
                    rowspan="2"><%=sqlSelB.getString(1)%>
                </TD>
                <TD> Tərtib olunma tarixi: <%=sqlSelB.getString(2)%></TD>
            </TR>
            <TR>
        ...
        <TABLE style="font-weight: bold;" frame="hsides">
            ...
            <TR>
                ...
                <TD><%=sqlSelB.getString(4)%></TD>
            </TR>
            <TR>
                <TD>Ünvanı:</TD>
                <TD><%=sqlSelB.getString(5)%></TD>
            </TR>
            <TR>
                <TD><SPAN style="font-weight: bold;">Doğum yeri:</SPAN></TD>
                <TD><%=sqlSelB.getString(6)%></TD>
            </TR>
            <TR>
                <TD>Doğum tarixi:</TD>
                <TD><%=sqlSelB.getString(7)%></TD>
            </TR>
            </TBODY>
        </TABLE>
        <BR><!-- ***************** Kredit Melumatlarinin icmali ***************************-->
        ...
        <TABLE width="705" class="tab1" border="0" cellspacing="0">
            ...
            <TR>
                ...
                <TD width="110" align="right" style="font-weight: bold;">
                    <%=formatter.format(Rsql_5.getDouble("QALIQ_MEBLEG"))%>
                </TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("say")%>
                </TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("U_tesh_say_aktiv")%></TD>
            </TR>
            <TR>
                <TH style="font-weight: normal;">1.1</TH>
                <TD>Kreditlər üzrə qalıq məbləğ</TD>
                <TD width="110" align="right" style="font-weight: bold;"><%=
                    formatter.format(Rsql_5.getDouble("QALIQ_KREDIT"))%>
                </TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("KREDIT_SAY")%></TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("kr_tesh_say_aktiv")%>
                </TD>
            </TR>
            <TR>
                ...
                <TD width="110" align="right" style="font-weight: bold;">
                    <%=formatter.format(Rsql_5.getDouble("QALIQ_XETT"))%>
                </TD>
                ...
                <TD width="110" align="center" style="font-weight: bold;">
                    <%=Rsql_5.getString("kr_xett_tesh_say_aktiv")%>
                </TD>
            </TR>
            <TR>
                ...
                <TD width="110" align="right" style="font-weight: bold;">
                    <%=formatter.format(Rsql_5.getDouble("QALIQ_QARANTIYA"))%>
                </TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("QARANTIYA_SAY")%></TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("qar_tesh_say_aktiv")%>
                </TD>
            </TR>
            <TR>
                <TH>2</TH>
                ...
                <TD width="110" align="right" style="font-weight: bold;">
                    <%=formatter.format(Rsql_5.getDouble("AYLIQ_ODENISH"))%>
                </TD>
            ...
            <TR>
                ...
                <TD width="110" align="right" style="font-weight: bold;">
                    <%=formatter.format(Rsql_5.getDouble("kredit"))%>
                </TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("kr_say")%></TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("U_tesh_say_bagli")%></TD>
            </TR>
            <TR>
                <TH>4</TH>
                <TD><STRONG>Zamin olduğu öhdəliyin məbləği</STRONG></TD>
                <TD width="110" align="right" style="font-weight: bold;">
                    <%=formatter.format(Rsql_5.getDouble("sum_zamin"))%>
                </TD>
                <TD width="110" align="center" style="font-weight: bold;"><%=Rsql_5.getString("count_zamin")%></TD>
                <TD width="110" align="center"
                    style="font-weight: bold;"><%=Rsql_5.getString("GUA_BANK_ID")%>
                </TD>
            </TR>
            </TBODY>
        </TABLE>
        ...
        <TABLE width="710" style="border: 1px solid rgb(215, 235, 249); border-image: none;"
            ...
            <TR style="height: 30px; font-size: medium; font-weight: bold;" bgcolor="#d7ebf9">
                ...
                <TD width="160"><SPAN
                        style="font-weight: bold;"><%=formatter.format(Rsql_3.getDouble("qaliq_mebleg"))%></SPAN></TD>
                <TD width="240">Faiz məbləği</TD>
                <TD width="160"><SPAN
                        style="width: 200px;"><%=formatter.format(Rsql_3.getDouble("FAIZ_MEBLEG"))%></SPAN></TD>
            </TR>
            <TR>
                ...
                <TD width="160"><%=Rsql_3.getString("GRANTED_ON")%></TD>
            </TR>
            <TR bgcolor="#d7ebf9">
                ...
                <TD width="100"><%=Rsql_3.getString("CONTRACT_DUE_ON")%></TD>
            </TR>
            <TR>
            ...
            <TR bgcolor="#d7ebf9">
                ...
                <TD width="100"><%=Rsql_3.getString("FAIZ_BORC_GEC_GUN")%></TD>
            </TR>
            </TBODY>
        </TABLE>
        <BR>
        <FIELDSET title="Təminat" style="padding: 4px; width: 700px;">
            <LEGEND style="font-weight: bold;">Təminatı</LEGEND>
        ...
        array[1] = 13;
        array[2] = 13;
        array[3] = "liabilityid='" + Rsql_3.getString("pl_id") + "'";
        ...
        ResultSet Rsql_6 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
        ResultSet Rsql_8 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
        ...
        ResultSet Rsql_6_check = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
        ...
        ResultSet Rsql_7 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);  
        ...
        <FIELDSET style="padding: 4px; width: 700px;">
            <TABLE width="710">
                ...
                <TR>
                    ...
                    <TD><SPAN style="font-weight: bold;">Hesab nömrəsi:</SPAN><SPAN
                            style="font-weight: bold;">XXXX</SPAN>
                    </TD>
                </TR>
                </TBODY>
            </TABLE>
            <TABLE width="710" style="border-color: rgb(102, 153, 255);" cellspacing="0">
                ...
                <TR bgcolor="#d7ebf9">
                    ...
                    <TD width="140">-</TD>
                    <TD width="240">Kreditin verilmə tarixi</TD>
                    <TD width="140"><%=Rsql_4.getString("GRANTED_ON")%></TD>
                </TR>
                <TR>
                    <TD width="240">Sonuncu ödəniş tarixi</TD>
                    <TD width="140"><%=Rsql_4.getString("SON_ODENISH")%></TD>
                    <TD width="280">Kreditin ilkin müqavilə ilə bitmə tarixi</TD>
                    <TD width="100"><%=Rsql_4.getString("CONTRACT_DUE_ON")%></TD>
                </TR>
                <TR bgcolor="#d7ebf9">
                    <TD width="180">Məqsədi</TD>
        ...
        array[1] = 16;
        array[2] = 16;
        array[3] = "liabilityid='" + Rsql_4.getString("pl_id") + "'";
        
        //ResultSet Rsql_61 = stmt_61.executeQuery(sql_61);
        //ResultSet Rsql_81 = stmt_81.executeQuery(sql_61);
        ResultSet Rsql_61 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
        ResultSet Rsql_81 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection);
        ...
        ResultSet Rsql_61_check = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
        ...
        ResultSet Rsql_71 = wd.callOracleStoredProcCURSORParameter(array, properties.getProperty("ProcName"), 0, dbConnection); 
        ...
        <TABLE width="710" style="border: 1px solid rgb(215, 235, 249); border-image: none;"
            ...
            <TR style="height: 30px; font-size: medium; font-weight: bold;" bgcolor="#d7ebf9">
                <TD width="240">Kreditin qalıq məbləği</TD>
                <TD width="160"><SPAN style="font-weight: bold;"><%=formatter.format(Rsql_3_z.getDouble(6))%></SPAN>
                </TD>
                <TD width="240">Faiz məbləği</TD>
                <TD width="160"><SPAN style="width: 200px;"><%=formatter.format(Rsql_3_z.getDouble(7))%></SPAN></TD>
            </TR>
            <TR>
                <TD width="240">Aylıq ödəniş məbləği</TD>
                <TD width="140"><%=formatter.format(Rsql_3_z.getDouble(8))%></TD>
                <TD width="240">Kreditin verilmə tarixi</TD>
                <TD width="160"><%=Rsql_3_z.getString(9)%></TD>
            </TR>
            <TR>
                <TD width="180">Məqsədi</TD>
                <TD width="240"><%=Rsql_3_z.getString(10)%></TD>
                <TD width="280">Kreditin son müqavilə ilə bitmə tarixi</TD>
                <TD width="100"><%=Rsql_3_z.getString(11)%></TD>
            </TR>
            </TBODY>
        </TABLE>
        <BR><!-- END of guarantee loans -->
        <BR>
        <% } %>
        <br>
        ...
        <TABLE class="tab" style="border: 1px solid gray; border-image: none; width: 706px;">
            ...
            <TR>
                ...
                <TD>181-360 gün gecikmə</TD>
            </TR>
            <TR>
                <TD align="center" bgcolor="#b40404">361+</TD>
                <TD colspan="5">360 gündən artıq gecikmə</TD>
            </TR>
            </TBODY>
        </TABLE>
    ...
    %>
    <INPUT name="javax.faces.ViewState" id="javax.faces.ViewState" type="hidden"
           value="-2939335497159985382:2762042233734743950" autocomplete="off">
