...
<html> 
    <%
        ...
        properties = rf.ReadConfigFile("Statement.properties");
    %>
    <head>
  ...
  //String frmActPath="StatmRep.jsp?uname="+user_name+"&br="+br;
        ...
        <table border="0" width="100%" height="100%"> 
            <col width="200">
            <tr>
                <td width="246" height="60">  <font face="Times new roman" size="5">  <%=properties.getProperty("Stat")%> </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top"> 
                    ...
                    <form method="post"  name="post" action="StatmRepForm.jsp" target="_blank" onsubmit="return validateForm()" >
                                    ...
                                    <table width="535"  border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            ...
                                            <td> <select name="forSrc" style="width: 150px">
                                                    ...
                                                    <option value="4"><%=properties.getProperty("Tpn")%></option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td height="27"> <%=properties.getProperty("RepLangDef")%>  </td>
                                            <td height="27">
                                                <input type="radio" name="replang" value="AZE" checked> <font size="3"> <%=properties.getProperty("RepLangAZ")%> </font>
                                                <input type="radio" name="replang" value="ENG" > <font size="3"> <%=properties.getProperty("RepLangEN")%> </font>  
                                            </td>
                                        </tr>
