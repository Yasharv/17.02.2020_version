<%-- 
    Document   : ProblemDepart
    Created on : Apr 24, 2018, 3:27:26 AM
    Author     : r.ganiyev
--%>
...
<html>
    <head>
        <%
            ...
            properties = rf.ReadConfigFile("ProblemDepart.properties"); 
        %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="ProblemDepartForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
