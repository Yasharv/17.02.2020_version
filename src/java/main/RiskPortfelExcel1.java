 ...
 */
@WebServlet(name = "RiskPortfelExcel1", urlPatterns = {"/RiskPortfelExcel1"})
public class RiskPortfelExcel1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String Text = "  SELECT  * FROM sql_select_copy  where id = 9 ";
            ...
            SqlCredLines = SqlCredLines.replaceAll("filialSql", Filial);
            SqlCredLines = SqlCredLines.replaceAll("Tarix", Tarix);

            SqlCredits = SqlCredits.replaceAll("filialSql", Filial);
            SqlCredits = SqlCredits.replaceAll("Tarix", Tarix);

            SqlBankCredits = SqlBankCredits.replaceAll("filialSql", Filial);
            SqlBankCredits = SqlBankCredits.replaceAll("Tarix", Tarix);

            SqlCardCredits = SqlCardCredits.replaceAll("filialSql", Filial);
