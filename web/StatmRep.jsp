...
<html>
    ...
    <body bgcolor=#E0EBEA> <!--  #E8E8E8 -->
        ...
        <%
            Date d = new Date();
            DB db = new DB();
            StatementRep html = new StatementRep();
            ...
            String repLang=request.getParameter("replang");
                                ...
                                if (turnover.equals("1")) {
                                    ...
                                    while (sqlTrCnt.next()) {
                                        if (sqlTrCnt.getInt(1) > 0) {
                                            ...
                                            out.println("<tr><td>");
                                            out.println(html.main(acc_no, acc_name, curr_name, CurrID, acc_open_date, cust_inn, strDateB, strDateE, AP, reval, br, insurance, salary_gr,repLang));
                                            chk = 1;
                                            out.println("</td></tr>");
                                        }
                                    }
        ...
        <td valign="top" >
            ...
            <FORM  method="post" action="Print2PDF" name="post">
                ...
                <input type="hidden" name="repLang" value="<%=repLang%>">
