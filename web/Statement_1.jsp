...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("Statement_1.properties");
    %>
    <head>
...
// String frmActPath="StmtExcel?uname="+uname+"&br="+br;
        ...
        <table border="0" width="100%" height="100%"> 
            <col width="200">
            <tr>
                <td width="246" height="60">  <font face="Times new roman" size="5"><%=properties.getProperty("StatReman")%></font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top"> 
                    ...
                    <form method="post"  name="post" action="StatmRepForm_1.jsp" target="_blank" onsubmit="return validateForm()" >
