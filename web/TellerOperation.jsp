...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("TellerOperation.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="TellerForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            <td height="27"><%=properties.getProperty("Times")%></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("OperationType")%> </td>
                                            <td>
                                                <select style="width: 150px">
                                                    <option value="1">equals</option>
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" name="transaction" value="" />
                                            </td>
                                        </tr>
