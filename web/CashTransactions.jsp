...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("CashTransactions.properties");
    %>
    <head>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="200" height="60">  
                    ...
                    <%=properties.getProperty("CashTrans")%>
                    </font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="CashTransactionsForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td width="150" height="33"><%=properties.getProperty("TimeInterval")%></td>
                                            <td width="110" align="center">
                                                <input style="width: 70px" type="text" name="TimeB"  maxlength="4"/>
                                            </td>
                                            <td width="130"> 
                                                <input style="width: 70px" type="text" name="TimeE"  maxlength="4"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="150" height="33"><%=properties.getProperty("InputOraauto")%></td>
                                            <td width="110" align="center">
                                                <input type='checkbox' name='RepType' value='1' ><%=properties.getProperty("Input")%>
                                            </td>
                                            <td width="130"> 
                                                <input type='checkbox' name='RepType' value='2' ><%=properties.getProperty("Aouto")%>
                                            </td>
                                        </tr>
                                        <tr>
