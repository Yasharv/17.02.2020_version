...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("IbPayment.properties");
    %>
    <head>
    ...
    <body bgcolor=#E0EBEA>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    <!-- <div align="left" > -->
                    <form method="post" action="IbPaymentForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                            ...
                            <tr>
                                <td>
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        ...
                                        <tr>
                                            <td height="27"><%=properties.getProperty("DateFrom")%></td>
                                            <td>
