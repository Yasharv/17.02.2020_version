...
public class StatementRep_1 {
    ...
    public String main(String acc_no, String acc_name, String curr_name, int CurrID, String acc_open_date, String cust_inn, String DateB, String DateE, String AP, String reval, String br, boolean insurance, String salary_gr) throws UnknownHostException {
        ...
        try {
            ...
            SQLText = "  select a.* , b.BALANCE_FCY_AMOUNT, b.BALANCE_LCY_AMOUNT from (     "
                    ...
                    + " FROM " + table + " a  where acct_no_dt = ('" + acc_no + "') and (tarix BETWEEN to_date('" + DateB + "','dd-mm-yyyy') "
                    ...
                    + " FROM " + table + " a  where"
                    + " acct_no_cr = ('" + acc_no + "') and (tarix BETWEEN to_date('" + DateB + "','dd-mm-yyyy') "
                    + " AND to_date('" + DateE + "','dd-mm-yyyy'))" + TrType
                    + "  ORDER BY tarix  ) a , ( select * from ST_XF_DWH.SI_ACCOUNT_BALANCE  "
                    + " union all select * from ST_XF_DWH.SI_ACCOUNT_OFF_BALANCE ) b where a.HESAB = b.ALT_ACCT_ID(+) "
...
//----------------------------------------------------------------------
            ...
            while (sqlres.next()) {
                ...
                mebleg = sqlres.getDouble(14);
                mebleg_lcy = sqlres.getDouble(15);
                ...
                if ((dCurrID == 944) && (cCurrID == 944)) {
                    meb = String.valueOf(twoDForm.format(mebleg_lcy));
                    ...
                    meb = String.valueOf(twoDForm.format(mebleg_lcy)) + "<BR><b>" + String.valueOf(twoDForm.format(mebleg)) + "</b>";
                ...
                grid = grid + " <tr>"
                        ...
                        + "  <td>&nbsp;</td>"
                        + "  <td valign='top'><center>" + meb + "</center></td>"
                        + "  <td>&nbsp;</td>"
