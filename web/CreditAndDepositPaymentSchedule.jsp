...
<html>
    <%
        ...
        properties = rf.ReadConfigFile("CreditAndDepositPaymentSchedule.properties");
    %>
    <head>
    ...
    <body bgcolor=#E0EBEA> <!--  #E8E8E8 -->
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                <td width="246" height="60">  <font face="Times new roman" size="5"><%=properties.getProperty("RepCreditAndDepositPaymentSchedule")%></font> </td>
                <td align="right">
            ...
            <tr>
                ...
                <td valign="top"> 
                    ...
                    <form method="post"  name="post" action="CreditAndDepositPaymentScheduleForm.jsp" target="_blank" onsubmit="return validateForm()" >
                                ...
                                <td>
                                    <table width="535"  border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input type="radio" name="Kind" value="1" checked><%=properties.getProperty("Credit")%> 
                                                <input type="radio" name="Kind" value="2"><%=properties.getProperty("Deposit")%> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="31"><%=properties.getProperty("ActDate")%></td>
                                            <td>
                                            ...
                                            <td width="130">
                                                <input type="text" id="to" name="ActDate" value= <% out.print('"' + s + '"'); %> />
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="ContractId" value="" />
                                            </td>
                                        </tr>
                                        <tr>
