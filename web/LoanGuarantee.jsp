<%-- 
    Document   : LoanGuarantee
    Created on : Dec 10, 2018, 2:59:11 PM
    Author     : r.ganiyev
--%>
...
<html>
    <head>
        ...
        properties = rf.ReadConfigFile("LoanGuarantee.properties"); 
       %>
        ...
        <table border="0" width="100%" height="100%"> 
            ...
            <tr>
                ...
                <td valign="top">    
                    ...
                    <!-- <div align="left" > --> 
                    <form method="post" action="LoanGuaranteeForm.jsp" target="_blank" name="post" onsubmit="return validateForm()" >
                                    ...
                                    <table width="535" height="101" border="0" bgcolor=#EBF9F9>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="radio" name="status" value="1"><%=properties.getProperty("CrStBalance")%>
                                                <input type="radio" name="status" value="2"><%=properties.getProperty("CrStOffBalance")%> 
                                                <input type="radio" name="status" value="3" checked><%=properties.getProperty("CrStBoth") %> 
                                            </td>
                                        </tr> 
